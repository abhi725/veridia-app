...
const pages = {
    ...
    '/about': { title: 'About SwanDigitals', content: 'Learn about our mission to revolutionize enterprise AI' },
    ...
    '/case-studies': { title: 'Customer Success Stories', content: 'See how companies use SwanDigitals' },

    // TIER 2: Product Pages (7 pages)
    '/features': { title: 'Features Overview', content: 'Explore all SwanDigitals capabilities' },
    ...
    '/why-SwanDigitals': { title: 'Why Choose SwanDigitals', content: 'Our competitive advantages' },
    '/compare/vs-kore': { title: 'SwanDigitals vs Kore.ai', content: '10x faster deployment' },
    '/compare/vs-yellow': { title: 'SwanDigitals vs Yellow.ai', content: 'True on-premise hosting' },
    '/compare/vs-ibm': { title: 'SwanDigitals vs IBM watsonx', content: 'Modern tech stack' },
