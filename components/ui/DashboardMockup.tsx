        ...
        <div className="w-full max-w-lg mx-auto lg:max-w-none select-none">
            ...
            <div className="bg-slate-800 rounded-2xl overflow-hidden shadow-2xl border border-slate-700">
                ...
                <div className="flex h-[340px]">
                    {/* Left sidebar */}
                    <div className="w-14 bg-slate-900 flex flex-col items-center py-4 gap-4 border-r border-slate-700">
                    ...
                    {/* Conversation list */}
                    <div className="w-44 bg-slate-800 border-r border-slate-700 overflow-hidden">
                ...
                {/* Bottom stat bar */}
                <div className="bg-slate-900 px-4 py-2.5 flex items-center gap-6 border-t border-slate-700">
                    {[
