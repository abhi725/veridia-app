...
export default function DemoHubContent() {
    const demos = [
    ...
    return (
        <SiteLayout>
            <Hero badge="🎬 Demo Hub" title="See SwanDigitals in Action" subtitle="Interactive product demos and walkthroughs. No signup required." primaryCTA={{ text: "Book Live Demo", href: "/demo" }} secondaryCTA={{ text: "Start Free Trial", href: "/demo" }} />
            ...
            <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    ...
                    <p className="text-center mt-6 text-white/90">10 minute walkthrough of the complete SwanDigitals platform — from building your first bot to analyzing results.</p>
                </div>
            </section>
                        ...
                        {demos.map((demo, i) => (
                            <div key={i} className="bg-white border-2 border-slate-200 rounded-2xl p-6 hover:border-purple-300 hover:shadow-lg transition-all cursor-pointer">
                                <div className="flex items-start gap-4 mb-4">
                                    <div className="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center text-purple-600">{demo.icon}</div>
                                    <div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="text-purple-600 font-semibold text-sm hover:underline flex items-center gap-1"><Play className="w-4 h-4" />Watch Demo</button>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-20 bg-slate-50">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/demo" className="px-8 py-4 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-full font-semibold text-lg shadow-xl hover:scale-105 transition-all">Book Live Demo</Link>
                        <Link href="/contact" className="px-8 py-4 bg-slate-900 text-white rounded-full font-semibold text-lg hover:bg-slate-800 transition-all">Contact Sales</Link>
                    </div>
                </div>
            </section>
        </SiteLayout>
