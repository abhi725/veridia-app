    ...
    const demos = [
        {
            ...
            description: "See how SwanDigitals handles complex support inquiries with context-aware responses",
            duration: "5 min",
        ...
        },
        {
            ...
            description: "Full tour of the SwanDigitals platform: builder, analytics, and deployment",
            duration: "10 min",
        ...
        },
        {
            ...
            description: "Connect SwanDigitals to Zendesk, Salesforce, and Slack in minutes",
            duration: "6 min",
            ...
            <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    ...
                    <p className="text-center mt-6 text-white/90">
                        10 minute walkthrough of the complete SwanDigitals platform - from building your first bot to analyzing results.
                    </p>
                </div>
            </section>
