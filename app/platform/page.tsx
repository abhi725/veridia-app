        ...
        <SiteLayout>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-5xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="text-center mt-8">
                        <Link href="/why-SwanDigitals" className="text-orange-600 font-semibold hover:underline">
            ...
            <section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900 text-white">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-white/80 mb-8">Get a personalized demo and see how SwanDigitals compares to your current solution.</p>
