                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="bg-yellow-50 border-2 border-yellow-200 p-6 rounded-xl mb-12">
                        ...
                        <p className="text-yellow-700">
                            Please read these Terms carefully before using our Service. By accessing or using SwanDigitals,
                        ...
                        <div className="text-slate-700 space-y-4">
                            ...
                            <div className="bg-slate-50 p-4 rounded-lg">
                                ...
                                <ul className="space-y-1 text-sm">
                                    <li><strong>"Service"</strong> - The SwanDigitals chatbot platform, APIs, and related services</li>
                    ...
                    <div className="mb-12">
                        ...
                        <div className="text-slate-700 space-y-4">
                            ...
                            <p>
                                ...
                                branding, is owned by SwanDigitals and protected by copyright, trademark, and other
                            ...
                            <p>
                                You retain all rights to Customer Data you upload or create. You grant SwanDigitals a
                    ...
                    <div className="mb-12">
                        ...
                        <div className="text-slate-700 space-y-4">
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li><strong>By SwanDigitals:</strong> We may terminate for material breach with 30 days notice to cure</li>
