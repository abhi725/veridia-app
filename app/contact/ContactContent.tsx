                            ...
                            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-100 relative">
                                ...
                                <Script id="eh-script-contact" strategy="afterInteractive">
                                    ...
                                    (window.EhDynamicRef ||= []).push(() => {
                                        EhForms.create({
                                            "formId": "5903844064886784",
                                            "target": "#eh_form_5903844064886784",
            ...
            <section className="py-20 bg-white">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link href="/faqs" className="px-6 py-3 bg-white border-2 border-slate-200 text-slate-900 rounded-full font-semibold hover:border-orange-300 transition-all">
                            Read FAQ
                        </Link>
                    </div>
                </div>
