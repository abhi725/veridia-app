    ...
    const cookieCategories = [
        {
            ...
            cookies: [
                { name: "__session", purpose: "User session management", duration: "Session", provider: "SwanDigitals" },
                { name: "__csrf", purpose: "Security token for form submissions", duration: "Session", provider: "SwanDigitals" },
                { name: "cookie_consent", purpose: "Stores your cookie preferences", duration: "1 year", provider: "SwanDigitals" }
            ]
        },
        {
        ...
        },
        {
            ...
            cookies: [
                { name: "theme", purpose: "Stores your theme preference (light/dark)", duration: "1 year", provider: "SwanDigitals" },
                { name: "language", purpose: "Stores your language preference", duration: "1 year", provider: "SwanDigitals" },
                { name: "dismissed_banners", purpose: "Tracks which announcements you've seen", duration: "6 months", provider: "SwanDigitals" }
            ]
        }
    ];
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                                ...
                                <div className="bg-purple-50 p-4 rounded-lg">
                                    ...
                                    <ul className="mt-2 text-sm text-purple-700 space-y-1">
                                        <li><strong>First-party:</strong> Set by SwanDigitals</li>
