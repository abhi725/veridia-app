...
export default function PartnersPage() {
    const partnerTypes = [
        { icon: <Building2 className="w-8 h-8" />, title: "Technology Partners", desc: "Integrate SwanDigitals into your product suite", partners: ['Salesforce', 'Microsoft', 'AWS', 'Google Cloud'] },
        { icon: <Users className="w-8 h-8" />, title: "Solution Partners", desc: "Implement SwanDigitals for your clients", partners: ['Accenture', 'Deloitte', 'EY', 'McKinsey Digital'] },
        { icon: <Globe className="w-8 h-8" />, title: "Reseller Partners", desc: "Distribute SwanDigitals in your region", partners: ['Regional partners worldwide'] },
    ...
    return (
        <SiteLayout>
            <Hero
                ...
                title="Grow Your Business with SwanDigitals"
