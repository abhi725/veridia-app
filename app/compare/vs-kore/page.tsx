...
export default function VsKorePage() {
    const comparisonRows = [
        { feature: "Implementation Time", SwanDigitals: "2-4 weeks", competitor: "3-6 months" },
        { feature: "Deployment Speed", SwanDigitals: true, competitor: false },
        { feature: "Monthly Cost (Professional)", SwanDigitals: "$1,999", competitor: "$5,000+" },
        ...
        { feature: "Setup Fees", SwanDigitals: "$0", competitor: "$10,000+" }
    ];
    ...
    return (
        <SiteLayout>
            <Hero
                ...
                subtitle="See why companies switch to SwanDigitalsfor 10x faster deployment and 60% lower costs"
            ...
            <section className="py-20 bg-white">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-slate-600 mb-8">
                        Join 50+ companies who migrated from Kore.ai to SwanDigitals
                    </p>
