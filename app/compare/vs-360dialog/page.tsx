...
export const metadata: Metadata = {
    ...
    description: '360dialog is just an API backend. Stop building UIs from scratch. Switch to SwanDigitals for a complete out-of-the-box omnichannel AI platform.',
...
export default function Vs360dialogPage() {
    return (
        <ComparisonPageTemplate
            ...
            realityCheck="360dialog is just an API backend. If you use 360dialog, you still have to hire a team of developers to build the frontend inbox, the SLA ticketing system, the analytics dashboard, and the entire LLM infrastructure. This takes months of engineering time and hundreds of thousands of rupees. Why reinvent the wheel when SwanDigitals gives you the enterprise frontend AND the AI backend out of the box?"
            reasonsToSwitch={[
                {
                    title: "Ready-to-Deploy Frontend",
                    description: "SwanDigitals provides a beautifully designed, consumer-grade Unified Inbox on day one. Stop wasting engineering hours building basic chat interfaces."
                },
                {
                    title: "Pre-Built Native AI",
                    description: "Integrating an LLM with WhatsApp securely is hard. SwanDigitals has already built the vector databases, RAG architecture, and prompt guardrails for you."
                },
                {
                    title: "Beyond WhatsApp",
                    description: "360dialog is an API for WhatsApp. SwanDigitals is a complete, ready-to-use UI and Helpdesk for WhatsApp, Email, Web Chat, Instagram, and Voice AI."
                }
            ]}
            comparisonRows={[
                { feature: "Platform Offering", SwanDigitals: "Full-Stack UI + Backend AI", competitor: "Raw API Backend Only" },
                { feature: "Time to Value", SwanDigitals: "Go Live in 7 Days", competitor: "Months of Custom Dev" },
                { feature: "Engineering Required", SwanDigitals: "Zero (No-Code Configuration)", competitor: "High (Full Dev Team Needed)" },
                { feature: "Native Voice AI", SwanDigitals: true, competitor: false },
                { feature: "Omnichannel Inbox UI", SwanDigitals: "Included", competitor: "Must be custom built" }
            ]}
            ...
            faqs={[
                {
                    question: "Can I use 360dialog as my BSP underneath SwanDigitals?",
                    answer: "Yes! If you already have a 360dialog API key, you can simply plug it into SwanDigitals's integration layer to use our AI and UI while keeping 360dialog as your provider."
                }
            ]}
        />
    );
