...
export const metadata: Metadata = {
    ...
    description: 'Compare SwanDigitals vs Kasisto. Dedicated banking AI that fully supports native Indian languages and true on-premise air-gapping.',
...
export default function VsKasistoPage() {
    return (
        <ComparisonPageTemplate
            ...
            comparisonRows={[
                { feature: "Primary Market", SwanDigitals: "India", competitor: "USA / Global" },
                { feature: "Indian Language NLU", SwanDigitals: "Native & Conversational", competitor: "Basic Translation" },
                { feature: "Deployment", SwanDigitals: "Air-Gapped On-Premise", competitor: "Cloud/Hybrid" },
                { feature: "Voice AI", SwanDigitals: "Native Indian Accents", competitor: "Third-party" },
                { feature: "Pricing Model", SwanDigitals: "Flat India-friendly SaaS", competitor: "Premium US Pricing" }
            ]}
            reasonsToSwitch={[
                {
                ...
                },
                {
                    ...
                    description: "When an Indian customer mixes Hindi and English on a WhatsApp voice note, SwanDigitals understands perfectly."
                },
                {
