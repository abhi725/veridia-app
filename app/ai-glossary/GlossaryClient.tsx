...
export default function GlossaryClient() {
    ...
    const glossaryTerms = [
        // --- Core AI Terms ---
        { term: "Agent", definition: "An AI-powered virtual assistant that can autonomously perform tasks, make decisions, and interact with users through natural language. SwanDigitals' AI agents resolve 80%+ of customer queries without a human agent.", category: "Core" },
        ...
        { term: "Entity Extraction", definition: "Identifying specific pieces of information (entities) from user input, such as data, order numbers, names, or locations. Accurate entity extraction reduces manual data entry for support agents by 60-70%.", category: "NLU" },
        ...
        { term: "Generative AI", definition: "AI systems that create new content — text, images, code — based on patterns learned from training data. Examples include GPT-4 and Gemini. Generative AI powers the response drafting in SwanDigitals' RAG system.", category: "AI/ML" },
        ...
        { term: "Intent", definition: "The goal behind a user's message. Accurate intent detection lets the AI route queries to the right answer or the right agent. Intent detection accuracy above 92% is the industry benchmark for production chatbots.", category: "NLU" },
        ...
        { term: "Large Language Model (LLM)", definition: "AI models trained on vast text data that understand and generate human-like text. SwanDigitals supports on-premise LLM deployment for BFSI clients, keeping models entirely within your datacenter.", category: "AI/ML" },
        ...
        { term: "Prompt Engineering", definition: "Designing and optimising prompts given to AI models to produce desired, accurate responses. Prompt engineering determines 40-60% of response quality for production LLM deployments.", category: "AI/ML" },
        { term: "RAG (Retrieval-Augmented Generation)", definition: "A technique combining retrieval of relevant documents from your knowledge base with AI text generation. RAG grounds every chatbot answer in your actual data, reducing hallucinations to near zero in production deployments.", category: "AI/ML" },
        ...
        { term: "Voice Bot", definition: "An AI assistant using speech recognition and synthesis to communicate via voice. SwanDigitals' Voice AI speaks Hindi, Tamil, Telugu, Marathi, and 7 more Indian languages with under 500ms response latency.", category: "Core" },
        { term: "On-Premise Deployment", definition: "Running software on servers within your own datacenter, not in a public cloud. Required by RBI for certain banking operations and preferred by BFSI clients for DPDP Act 2023 compliance.", category: "Deployment" },
        // --- India Compliance Terms (Phase 2: high-value awareness keywords) ---
        { term: "DPDP Act 2023", definition: "The Digital Personal Data Protection Act 2023 is India's first comprehensive data protection law, enacted in August 2023. It requires businesses to store and process Indian citizens' personal data within India's borders. SwanDigitals is DPDP Act 2023 compliant with 100% Indian datacenter hosting for all cloud plans.", category: "Compliance" },
        { term: "RBI Cloud Guidelines", definition: "The Reserve Bank of India's Master Direction on IT Governance (2021) and subsequent circulars require that regulated entities (banks, NBFCs, payment companies) ensure data localisation, audit rights, and business continuity for any cloud-hosted customer data. SwanDigitals' Sovereign Enterprise plan is designed to meet these RBI requirements.", category: "Compliance" },
        ...
        { term: "Green Tick Verification", definition: "WhatsApp's official business verification badge that displays a green checkmark next to a business name. Required for high-volume enterprise WhatsApp messaging. SwanDigitals preserves your existing Green Tick status during platform migrations.", category: "WhatsApp" },
        ...
        { term: "Per-Seat Pricing", definition: "A SaaS billing model charging per agent or user licence per month. Common in legacy helpdesks like Zendesk ($55/agent/month) and Intercom. For a team of 20 agents, per-seat pricing can cost 3-4x more than SwanDigitals' flat-rate plan.", category: "Pricing" },
        { term: "Air-Gapped Deployment", definition: "A security configuration where a system is completely isolated from external networks, including the public internet. Required by some defence, banking, and government clients. SwanDigitals' Sovereign Enterprise plan supports fully air-gapped on-premise deployment.", category: "Deployment" },
