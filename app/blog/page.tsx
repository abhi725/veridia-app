...
export default function BlogPage() {
    ...
    const posts = [
        { title: "SwanDigitals vs Kore.ai: 2024 Comparison Guide", excerpt: "Complete breakdown of features, pricing, and deployment times.", category: "Comparison", date: "Dec 12, 2024", readTime: "12 min" },
    ...
    return (
        <SiteLayout>
            <Hero
                badge="📝 SwanDigitals Blog"
                title="AI Insights for Enterprise"
                subtitle="Strategies, case studies, and technical guides from the SwanDigitals team. Learn how to deploy AI chatbots that actually work."
