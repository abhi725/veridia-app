                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    ...
                    <div id="section-1" className="mb-12">
                        ...
                        <div className="text-slate-700 space-y-4">
                            ...
                            <div className="bg-blue-50 p-4 rounded-lg">
                                ...
                                <p><strong>Leadership:</strong> Swati Gaikwad & Kiran Shelke</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="section-2" className="mb-12">
                        ...
                        <div className="text-slate-700 space-y-4">
                            ...
                            <p>
                                When you choose to log in or register for the SwanDigitals platform using <strong>Google Authentication (OAuth)</strong>,
                            ...
                            <ul className="list-disc pl-6 space-y-2 mt-2">
                                ...
                                <li><strong>How we use it:</strong> This restricted data is used exclusively to verify your identity, securely create or link your SwanDigitals account, and pre-fill your basic profile details within our dashboard.</li>
                            ...
                            <p className="mt-2">
                                You can revoke SwanDigitals's access to your Google account at any time via your <a href="https://myaccount.google.com/permissions" className="text-purple-600 hover:underline" target="_blank" rel="noopener noreferrer">Google Account Security settings</a>.
                            </p>
                        </div>
                    </div>
